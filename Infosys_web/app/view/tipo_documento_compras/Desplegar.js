Ext.define('Infosys_web.view.tipo_documento_compras.Desplegar', {
    extend: 'Ext.window.Window',
    alias : 'widget.tipodocumentodesplegar',

    requires: ['Ext.form.Panel','Ext.form.field.Text'],

    title : 'Editar Tipos de Movimientos',
    layout: 'fit',
    autoShow: true,
    width: 480,
    modal: true,
    ...
    initComponent: function() {
        ...
        this.dockedItems = [{
            ...
            items: ['->', {
                iconCls: 'icon-save',
                text: 'Grabar',
                action: 'tipomovimientograbareditar'
            },'-',{
                iconCls: 'icon-reset',
                text: 'Cancelar',
                scope: this,
