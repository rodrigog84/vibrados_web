Ext.define('Infosys_web.view.cuentascorrientes.CancelacionesPrincipal' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.cancelacionesprincipal',
    
    requires: ['Ext.toolbar.Paging'],
    
    iconCls: 'icon-grid',

    title : 'Cancelaciones Cuentas Corrientes',
        ...
        format: '0,000.'
            ...
            items: [{
                ...
                handler: function(grid, rowIndex, colIndex) {
                    ...
                    var vista = this.up('cancelacionesprincipal');
    ...
    initComponent: function() {
        ...
        this.dockedItems = [{
            ...
            items: [
            {
                xtype: 'button',
                iconCls: 'icon-add',
                action: 'agregarcancelacion',
                text : 'Ingresar Cancelaci&oacute;n'
            },'->',{
                            xtype: 'combobox',
                            fieldLabel: '<b>Rut:</b>',
                            store : 'Cuentacorriente',
