Ext.define('Infosys_web.view.guiasdespacho.BuscarClientes2' ,{
    extend: 'Ext.window.Window',
    alias : 'widget.guiasdespachobuscarclientes2',
    
    requires: ['Ext.toolbar.Paging'],
    title : 'Busqueda Clientes Guias',
    layout: 'fit',
    autoShow: true,
    width: 680,
    height: 380,
    ...
    initComponent: function() {
        ...
        this.dockedItems = [{
            ...
            xtype: 'button',
            margin: 5,
            action: 'seleccionarclienteguias2',
            dock: 'bottom',
            text : 'Seleccionar'
        },
        {
