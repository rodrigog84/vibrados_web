Ext.define('Infosys_web.view.guiasdespacho.BuscarClientes' ,{
    extend: 'Ext.window.Window',
    alias : 'widget.guiasdespachobuscarclientes',
    ...
    initComponent: function() {
        ...
        this.dockedItems = [{
            ...
            xtype: 'button',
            margin: 5,
            action: 'seleccionarclienteguias',
            dock: 'bottom',
            text : 'Seleccionar'
        },
        {
