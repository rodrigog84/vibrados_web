Ext.define('Infosys_web.view.proveedores.Desplieguesucursales' ,{
    extend: 'Ext.window.Window',
    alias : 'widget.desplegarsucursalesproveedores',
    
    requires: ['Ext.form.Panel','Ext.form.field.Text'],

    title : 'Sucursales Proveedores',
    layout: 'fit',
    autoShow: true,
    width: 800,
    modal: true,
        ...
        this.items = [
            {
                ...
                items: [{
                        xtype: 'button',
                        iconCls: 'icon-add',
                        action: 'agregaSucursalesproveedores',
                        text : 'Agregar'
